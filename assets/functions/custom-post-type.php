...
function sponsors() { 
	...
	register_post_type( 'sponsors', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Sponsors', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Sponsor', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Sponsors', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Sponsor', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Sponsor', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Sponsor', 'jointswp'), /* New Display Title */
			'view_item' => __('View Sponsor', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Sponsors', 'jointswp'), /* Search Custom Type Title */ 
