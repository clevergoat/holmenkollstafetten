...
<?php get_header(); ?>
	...
	<div id="content">
		...
		<a href="https://reg.eqtiming.no/?EventUID=20006" class="hero large expanded button" style="border-bottom: 3px solid lightgray;">
			<h2>Påmelding</h2>
			...
			<p class="show-for-medium">Svarene til alt du lurer på</p>
				...
				<div class="small-12 medium-4 large-4 columns">
						<a href="/hks/loypekart/" class="hero large expanded button" style="border-bottom: 3px solid lightgray;">
			<h2>Løypekart</h2>
